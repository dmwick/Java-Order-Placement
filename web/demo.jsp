...
<textarea class="form-control" name ="txtcus_addr" id="cus_addr" placeholder="Enter address" required></textarea>
 ...
 /> 
    ...
    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
    type = "tel"
    maxlength = "11"  placeholder="011-2790019" pattern="[0-9]{3}-[0-9]{7}" 
    ...
    <input type="text" class="form-control" name="txtcus_uname" id="cus_uname" placeholder=" " required>
     ...
     <div class="form-row">
         <div class="form-group col-md-3">
                       ...
                       <div class="form-group ">
                           <div class="form-check">
  <input class="form-check-input" type="checkbox" value="package1" id="packone" name="txt_packone">
  <label class="form-check-label" for="flexCheckDefault">
    Package 1
  </label>
</div>
            ...
            <div class="form-group col-md-1">
                                <div class="form-group ">
    <label for="firstname">LKR</label>
    <input type="text" class="form-control" name="txt_packprice1" id="packprice1" value="250" placeholder=""  readonly>
    </div>
     </div>
          <div class="form-group col-md-3">
                                <div class="form-group ">
   <label for="firstname">Qty</label>
    <input type="number" min="0"  oninput="this.value = Math.abs(this.value)" class="form-control"   name="txt_packquantity1" id="packquantity1" placeholder=" " onblur="calA(packprice1.value,packquantity1.value)">
    </div>  
     </div>
         <div class="form-group col-md-3">
                                <div class="form-group ">
    ...
    <input type="number" min="0"   step="0.01" oninput="this.value = Math.abs(this.value)" class="form-control"   name="txt_packsubtotal1" id="packsubtotal1" placeholder=" "  value="0.00"  readonly>
    </div>
     </div>
     </div>
     <div class="form-row">
         <div class="form-group col-md-3">
                       ...
                       <div class="form-group ">
                           <div class="form-check">
  <input class="form-check-input" type="checkbox" value="package2" id="packtwo" name="txt_packone">
  <label class="form-check-label" for="flexCheckDefault">
    Package 2
  </label>
</div>
    ...
    <input type="text" class="form-control" name="txt_packprice2" id="packprice2" value="250" placeholder=""  readonly>
    </div>
     </div>
          <div class="form-group col-md-3">
                                <div class="form-group ">
  
    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" class="form-control"   name="txt_packquantity2" id="packquantity2" placeholder=" " onblur="calB(packprice2.value,packquantity2.value)">
    </div>  
     </div>
         <div class="form-group col-md-3">
                                <div class="form-group ">
    ...
    <input type="number" min="0"  step="0.01" oninput="this.value = Math.abs(this.value)" class="form-control"   name="txt_packsubtotal2" id="packsubtotal2" placeholder=" "  value="0.00" readonly>
     ...
     <div class="form-row">
         <div class="form-group col-md-3">
                       ...
                       <div class="form-group ">
                           <div class="form-check">
  <input class="form-check-input" type="checkbox" value="package3" id="packone" name="txt_packone">
  <label class="form-check-label" for="flexCheckDefault">
    Package 3
  </label>
</div>
    ...
    <input type="text" class="form-control" name="txt_packprice3" id="packprice3" value="250" placeholder=""  readonly>
    </div>
     </div>
          <div class="form-group col-md-3">
                                <div class="form-group ">
 
    <input type="number" min="0"  oninput="this.value = Math.abs(this.value) " class="form-control"   name="txt_packquantity3" id="packquantity3" placeholder=" " onblur="calC(packprice3.value,packquantity3.value)">
    </div>  
     </div>
         <div class="form-group col-md-3">
                                <div class="form-group ">

    <input type="number" min="0"  step="0.01" oninput="this.value = Math.abs(this.value)" class="form-control"   name="txt_packsubtotal3" id="packsubtotal3" placeholder=" "  value="0.00" readonly>
